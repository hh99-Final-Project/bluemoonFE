        ...
        <IntroContainer>
            ...
            {isMobileQuery || isMobile ? (
                <Desc>
                    ...
                    <Fourth ref={animationRef}>세계 곳곳의 다이어리 주인들과 연결되고 있습니다....</Fourth>
                </Desc>
            ) : (
                <Desc>
                    <First>달빛이 유난히도 푸른 어느날, 나는 의문의 다이어리를 주웠다.</First>
                    <Second>
                        <FirstDiv>[이 다이어리는 블루문의 빛을 담아 마음을 위로해주는 다이어리입니다]</FirstDiv>
                        <SecondDiv>[블루문을 통해, 당신의 가장 솔직한 이야기를 공유해보세요.]</SecondDiv>
                    </Second>
                    <Third ref={animationRef}>세계 곳곳의 다이어리 주인들과 연결되고 있습니다....</Third>
                </Desc>
            )}
